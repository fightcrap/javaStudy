...
import com.pangxie.server.store.PxCache;
import com.pangxie.server.store.impl.BaseDataStore;
 ...
 * | @author fightingcrap
 **/
public class PxCache107<K,V> implements Cache<K,V> {

    private PxCache<K, V> csCache = new PxCache<K, V>(new BaseDataStore<K, V>());;
    private volatile boolean isClosed;

    private String cacheName;

    private PxCache107Manager cacheManager;

    private Configuration<K, V> configuration;

    public PxCache107(PxCache107Manager cacheManager, String cacheName, Configuration<K, V> configuration) {
